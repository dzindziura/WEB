...
exp.get("/ports", (req, res) => {
  res.render("pages/ports", { title: "Порти",
                                  use_db: USE_DB,
                                  server_port: SERVER_PORT,
                                  add_button: "Додати новий порт",
                                  page_id: "1" });
});

// ... для сторінки "Лікарі"
exp.get("/piers", (req, res) => {
  res.render("pages/piers", { title: "Пристані",
                                use_db: USE_DB,
                                server_port: SERVER_PORT,
                                add_button: "Додати нову пристань",
                                page_id: "2" });
});

// ... для сторінки "Пацієнти"
exp.get("/ships", (req, res) => {
  res.render("pages/ships", { title: "Кораблі",
                                 use_db: USE_DB,
                                 server_port: SERVER_PORT,
                                 add_button: "Додати нового корабля",
                                 page_id: "3" });
});

// ... для сторінки "Виписані пацієнти"
exp.get("/cured_ships", (req, res) => {
  res.render("pages/cured_ships", { title: "Виписані кораблі",
                                       use_db: USE_DB,
                                       server_port: SERVER_PORT,
